  ...
  try {
    ...
    const deliveryNote = await prisma.deliveryNote.findUnique({
      ...
      include: {
        ...
        lines: { orderBy: { position: "asc" }, include: { movement: { include: { invoiceLine: { include: { invoice: { select: { id: true, number: true } } } } } }, invoiceLine: { include: { invoice: { select: { id: true, number: true } } } } } },
      },
    });
